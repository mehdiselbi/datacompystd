            ...
            self.column_stats.append(
                {
                    ...
                    "std1": str(self.df1[column].std()),
                    "std2": str(self.df2[column].std()),
                    "mean1": str(self.df1[column].mean()),
                    "mean2": str(self.df2[column].mean()),
                    "all_match": all(
                        (
                ...
                match_stats.append(
                    {
                        ...
                        "{} std".format(self.df1_name): column["std1"],
                        "{} std".format(self.df2_name): column["std2"],
                        "{} mean".format(self.df1_name): column["mean1"],
                        "{} mean".format(self.df2_name): column["mean2"],
        ...
        if any_mismatch:
            ...
            report += df_match_stats[
                [
                    ...
                    "{} std".format(self.df1_name),
                    "{} std".format(self.df2_name),
                    "{} mean".format(self.df1_name),
                    "{} mean".format(self.df2_name),
                    "# Unequal",
                    "Max Diff",
                    "# Null Diff",
                ]
